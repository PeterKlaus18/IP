...
def ejecutar_buscar_amigo_con_mas_likes( a1:dict, a2:dict, 
    ...
    de likes.
    """
    amigo = cb.buscar_amigo_con_mas_likes( a1, a2, a3, a4 )
    print("El amigo ", amigo["nombre"]," es el amigo más famoso con ",amigo["likes"] ," likes.")
...
def ejecutar_buscar_amigo_con_menos_publicaciones( a1:dict, a2:dict, 
    ...
    """
    amigo = cb.buscar_amigo_con_menos_publicaciones( a1, a2, a3, a4 )
    print("El amigo ", amigo["nombre"]," es el amigo con el menor número de publicaciones")
...
desea buscar: ")
    ...
    if (amigo1==None):
        print("El amigo ",nombre_amigo1 ," no existe en CupiBook")
    elif(amigo2==None):
        print("El amigo ",nombre_amigo2 ," no existe en CupiBook")
    elif( cb.signo_es_compatible(amigo1,amigo2) ):
        print("El amigo ",nombre_amigo1," y el amigo ",nombre_amigo2 ," son compatibles según su signo.")
    else:
        print("El amigo ",nombre_amigo1," y el amigo ",nombre_amigo2," no son compatibles según su signo.")
...
desea buscar: ")
    ...
    if (amigo1==None):
        ...
        print("El amigo ",nombre_amigo2 ," no existe en CupiBook")
    elif( cb.es_cupiamigo(amigo1,amigo2) ):
        print("El amigo ",nombre_amigo1," y el amigo ",nombre_amigo2 ," son cupiamigos.")
    else:
        print("El amigo ",nombre_amigo1," y el amigo ",nombre_amigo2," no son cupiamigos.")
...
def ejecutar_determinar_cupienemigo( a1:dict, a2:dict, 
    ...
    if (amigo==None):
        print("El amigo ",nombre ," no existe en CupiBook")
    elif( cb.es_cupienemigo(amigo) ):
        print("El amigo ",nombre," es cupienemigo")
    else:
        print("El amigo ",nombre," no es cupienemigo.")
