...
import modulo_examen_peliculas as modex
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio= int(input("Ingrese el anio de la pelicula que desea: "))
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print(mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5))
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    nueva_hora= int(input("Ingrese la hora a la que desea reagendar: "))
    nuevo_dia= input("Ingrese el dia al que desea reagendar: ")
    control_horario= input("Desea activar el control de horario?: ")
    
    x= mod.reagendar_pelicula(peli, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    edad_invitado=int(input("Ingrese la edad: "))
    autorizacion_padres=input("Tiene autorizacion?: ")
    
    print(mod.decidir_invitar(pelicula, edad_invitado, autorizacion_padres))
    
    
def ejecutar_buscar_dia_mas_tarde_genero( p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    
    genero= input("digite genero:")
    
    print(modex.buscar_dia_mas_tarde_genero(genero, p1, p2, p3, p4, p5))
    
    
    
 
def ejecutar_balancear_peliculas(p1: dict, p2: dict, p3: dict, p4: dict,  p5: dict)->None:
    
    dia= input("Digite el dia: ")
    
    print(modex.balancear_peliculas(dia, p1, p2, p3, p4, p5))
...
def mostrar_menu_aplicacion(p1: dict, p2: dict, p3: dict, p4:dict, p5:dict) -> bool:
    ...
    print(" 7 - Buscar pelicula mas tarde del genero")
    ...
    if opcion_elegida == "1":
        ...
        ejecutar_buscar_dia_mas_tarde_genero(p1, p2, p3, p4, p5)    
